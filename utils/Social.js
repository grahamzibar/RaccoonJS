(function() {
	...
	utils.Social = new (function Social() {
		...
		this.share = function(relativeUrl, title, absolute) {
			...
			var p = ".php?t=" + e(title ? title : window.document.title) + "&u=" + e(!absolute ? (window.location.protocol + "//" + window.location.host + relativeUrl) : relativeUrl);
		...
		this.tweet = function(relativeUrl, title, prefix, absolute) {
			var link = "http://twitter.com/home?status=" + encodeURIComponent((prefix ? prefix + " " : "") + (title ? title : window.document.title) + " " + (!absolute ? (window.location.protocol + "//" + window.location.host + relativeUrl) : relativeUrl));
			__self__.b = function() {
