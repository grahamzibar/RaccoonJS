...
utils.Browser = new (function Browser() {
	...
	/* What about #! - Something to think about.  We might include this in the future and make it legacy.  Don't foresee it
	   anytime soon. */
	this.getUrl = function(excludeDomain) {
		if (!__self__.allowHash) {
			return __self__.currentUrl; // This is only if necessary... requires set-up on the developer's end.
		}
